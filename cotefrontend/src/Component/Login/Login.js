  ...
  return (
    <div className='loginForm'>
      <div className='imglogin'>
        ...
        <div className="wlc"><br />Welcome Again !</div>
      </div>
      <div className='Form'>
        <div className='LSN'>
        ...
        <div className='EPForm'>
          ...
          <Link style={{ textDecoration: "none", color: "#343beb", fontFamily: "'PT Sans', sans-serif", marginLeft: "0.6rem" }} to={'/user/forgot-password'}> Forgot Password ?</Link>
        </div>
