...
function Games() {
    ...
    if (isLoading) { // si les données sont en cours de chargement, afficher un message de chargement
        return <Box sx={{ display: 'flex' }}>
            <CircularProgress style={{ color: 'black', marginTop: '300px', marginLeft: '40rem', position: "center" }}></CircularProgress>
            <p style={{ color: 'black', marginTop: '300px', position: "center" }}>Chargement en cours...</p>
        </Box>
    }
    return (
        <Grid container direction="row" justifyContent="center" className="g1">
            ...
            <div className="row">
                {games
                    ...
                    .map(game => {
                        const boxArtUrl = game.box_art_url.replace('{width}', '1100').replace('{height}', '900');
                            ...
                            if (gamesapi[i].name.toLowerCase() === game.name.toLowerCase()) {
                                return (
                                    <div className="col-lg-4 col-md-6 col-sm-12 mt-5" key={game.id}>
                                        <div className="card">
                                            <img className="card-img-top" src={boxArtUrl} />
                ...
                <div className="col-lg-4 col-md-6 col-sm-12 mt-5">
                    <div className="card">
                        <img
                            ...
                            src={"https://static-cdn.jtvnw.net/ttv-boxart/502732_IGDB-{width}x{height}.jpg".replace('{width}', '300').replace('{height}', '400')}
                        />
                        <div className="card-body">
