...
import { TreatReclamation, getReclamationLive } from '../../Services/AdminService';

const token = localStorage.getItem("token");
console.log("token", token);
const columns = [
  { id: 'iduser', label: 'User', minWidth: 170, align: 'center' },
  { id: 'idlive', label: 'Live', minWidth: 120, align: 'center' },
...
export default function StickyHeadTable() {
  ...
  return (
    <Paper sx={{ bgcolor: '#222222' }}>
      <h1 sx={{ color: 'white !important', }}>List of Live Reclamations</h1>
      <TableContainer sx={{
