...
function EditTour(props) {
    ...
    useEffect(() => {
        if (Object.keys(formErrors).length === 0 && isSubmit) {
            ...
            if (image !== null) { put.append('photo', image.file); }
        ...
        <Grid
            ...
            <FormControl sx={{ m: 1, width: '52ch' }} >
                <Autocomplete
                    ...
                    value={values.jeux}
                    options={["Free Fire", ...games.map(game => game.name)].sort((a, b) => a.localeCompare(b))}
                    sx={{ width: '52ch' }}
                    renderInput={(params) => <TextField {...params} label="Jeux " required />}
            ...
            {/* number participants */}
            <FormControl required sx={{ m: 1, width: '52ch' }} variant="outlined">
                <InputLabel htmlFor="name" style={{ color: 'rgb(159, 156, 156)' }}>Number of participants</InputLabel>
                <OutlinedInput
                    name="nbparticipants"
                    onChange={handleChange}
            ...
            {/* Link */}
            <FormControl required sx={{ m: 1, width: '52ch' }} variant="outlined">
                <InputLabel htmlFor="name" style={{ color: 'rgb(159, 156, 156)' }}>Link</InputLabel>
                <OutlinedInput
                    name="link"
                    onChange={handleChange}
                    value={values.link}
            ...
            {/* Description */}
            <FormControl required sx={{ m: 1, width: '52ch' }} variant="outlined">
                <InputLabel htmlFor="description" style={{ color: 'rgb(159, 156, 156)' }}>Description</InputLabel>
                <OutlinedInput
                    name="description"
                    onChange={handleChange}
                            ...
                            {image && (
                                <div className="image-item">
                                    ...
                                    <div className="image-item__btn-wrapper">
                                        <button onClick={onImageUpdate} onChange={onChange}>Modify</button>
